...
public class SurnameComparator implements Comparator<PersonModel> {
	
	@Override
	public int compare(PersonModel fperson, PersonModel sperson){
		int i = 0;
		char[] firstperson = fperson.getSurname().toCharArray();
		char[] secondperson = sperson.getSurname().toCharArray();
